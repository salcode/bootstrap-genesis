...
function bsg_layout_options_modify_classes_to_add( $classes_to_add ) {
    ...
    if ( 'content-sidebar-sidebar' === $layout ) {
        ...
        $classes_to_add['sidebar-secondary'] = 'col-sm-4';
    }


    // sidebar-sidebar-content  // supported
    if ( 'sidebar-sidebar-content' === $layout ) {
        $classes_to_add['content'] = 'col-sm-4 col-sm-push-8';
        $classes_to_add['sidebar-primary'] = 'col-sm-4';
        $classes_to_add['sidebar-secondary'] = 'col-sm-4 col-sm-pull-8';
    ...
    if ( 'sidebar-content-sidebar' === $layout ) {
        $classes_to_add['content'] = 'col-sm-4 col-sm-push-4';
        $classes_to_add['sidebar-primary'] = 'col-sm-4 col-sm-push-4';
        $classes_to_add['sidebar-secondary'] = 'col-sm-4 col-sm-pull-8';
    }
